            ...
            <div className="home__header-left">
              ...
              <div>
                ...
                <p className="home__subtitle">
                  {todos.filter((t) => !t.completed).length}개의 할 일이
                  남았습니다
                </p>
              </div>
            </div>
        ...
        <div className="add-todo-form">
          <div className="add-todo-form__group">
            ...
            <SearchableSelect
              ...
              required
            />
            <small className="add-todo-form__hint">
              할 일은 반드시 일정에 소속되어야 합니다.
            </small>
          </div>
          <Input
            label="제목"
          ...
          <div className="add-todo-form__row">
            ...
            <Input
              ...
              onChange={(e) =>
                setNewTodo({
                  ...newTodo,
                  estimatedMinute: parseInt(e.target.value),
                })
              }
            />
          </div>
              ...
              <Input
                ...
                value={Math.floor(
                  Math.min(
                    ...
                    Math.max(
                      1,
                      editingTodo.importance || editingTodo.priorityScore || 5
                    )
                  )
                )}
                readOnly
